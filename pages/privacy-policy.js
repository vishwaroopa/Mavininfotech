...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <PageBanner title="Privacy Policy" homeText="Home" homeUrl="/" />

      <div className="privacy-policy-area ptb-100">
        <div className="container">
          <div className="privacy-policy-content">
            <p>
              <i>This Privacy Policy was last updated on September 1, 2022.</i>
            </p>
            <h3>
            ...
            <blockquote className="blockquote">
              <p>
                ...
                from third-party platforms you connect with Drove. We also
                collect some data automatically information about your device
